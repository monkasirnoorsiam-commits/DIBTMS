        ...
        $sql = "SELECT * FROM bus_seats WHERE bus_no = '$bus_no'";
                    ...
                    <div class="time-container">
                            ...
                            <?php if($seats >= 2){ ?>
                                ...
                                <span class="text-design" style="display: inline-block;">Seat3:</span>
                                    ...
                                    <?php if($seats >= 4){ ?>
                                      <div class="time-container">
                                <span class="text-design" style="display: inline-block;">Seat4:</span>
                                        ...
                                        <?php if($seats == 5){ ?>
                                           <div class="time-container">
                                <span class="text-design" style="display: inline-block;">Seat5:</span>
