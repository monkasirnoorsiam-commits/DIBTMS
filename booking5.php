    ...
    <form method="post">
        ...
        <?php if(isset($_POST['select5'])){
            ...
            if (($amount - $ride_cost) < 0){ echo"<script>alert('Insufficient funds!'); window.location.href='booking5.php';</script>"; }
                ...
                if(mysqli_query($conn, $sql)) { echo "<script>alert('Ride booked successfully!'); window.location.href='passenger.php';</script>"; }
                else { echo "<script>alert('Error booking ride!'); window.location.href='booking5.php';</script>"; }
