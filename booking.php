...
<body>
    <?php
        $start_from = null; $end_at = null; $user_id = $_SESSION["id"];
        ...
        $addresses = array("Aftabnagar", "Agargaon", "Airport", "Badda", "Banani", "Bangla Motor", "Bijoy Shoroni", "Cantonment",
                           "Dhanmondi", "ECB Chottor", "Farmgate", "Gulistan", "Gulshan", "Kamalapur", "Karwan Bazar", "Kalshi Flyover",
    ...
    <form action="<?php htmlspecialchars($_SERVER["PHP_SELF"])?>" method="post" class="booking-form"> From:
