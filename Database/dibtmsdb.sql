...
INSERT INTO `reviews` (`p_id`, `bus_no`, `comments`, `ratings`) VALUES
(300001, 1001, 'Mashallah nice ride', 4.5);
...
ALTER TABLE `ride_history`
  ADD KEY `ride_history_ibfk_1` (`p_id`),
  ADD KEY `ride_history_ibfk_2` (`bus_no`);

--
-- Indexes for table `time_slots`
--
ALTER TABLE `time_slots`
  ADD KEY `time_slots_ibfk_1` (`bus_no`);
...
--
ALTER TABLE `bus_managers`
  ADD CONSTRAINT `bus_managers_ibfk_1` FOREIGN KEY (`m_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `bus_seats`
--
ALTER TABLE `bus_seats`
  ADD CONSTRAINT `bus_seats_ibfk_1` FOREIGN KEY (`bus_no`) REFERENCES `bus_service` (`bus_no`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `passengers`
--
ALTER TABLE `passengers`
  ADD CONSTRAINT `passengers_ibfk_1` FOREIGN KEY (`p_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `payment_options`
--
ALTER TABLE `payment_options`
  ADD CONSTRAINT `payment_options_ibfk_1` FOREIGN KEY (`p_id`) REFERENCES `passengers` (`p_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `ride_history`
  ADD CONSTRAINT `ride_history_ibfk_1` FOREIGN KEY (`p_id`) REFERENCES `passengers` (`p_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ride_history_ibfk_2` FOREIGN KEY (`bus_no`) REFERENCES `bus_service` (`bus_no`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `time_slots`
--
ALTER TABLE `time_slots`
  ADD CONSTRAINT `time_slots_ibfk_1` FOREIGN KEY (`bus_no`) REFERENCES `bus_service` (`bus_no`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
